...
import ExecutiveDashboard from '../views/pages/dashboard/ExecutiveDashboard';
import PlantPerformanceDashboard from '../views/pages/dashboard/PlantPerformanceDashboard';
import AssetHealthDashboard from '../views/pages/dashboard/AssetHealthDashboard';
import SupplyChainDashboard from '../views/pages/dashboard/SupplyChainDashboard';
import SustainabilityDashboard from '../views/pages/dashboard/SustainabilityDashboard';
